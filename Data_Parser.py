...
from Film_Contents_IMDB import ImdbMovieContent
...
def parse_actors(movie):
    ...
    top_k = 3
    parsed_actors = {}
    parsed_actors['total_cast_fb_likes'] = sum([actor['actor_fb_likes'] for actor in movie['cast_info']]) + \
                                           movie['director_info']['director_fb_links']
