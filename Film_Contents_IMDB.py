...
class ImdbMovieContent():
  ...
  def get_facebook_likes(self, entity_id):
    ...
    try:
        ...
        likes_number = sentence.split(" ")[0]
    except Exception as e:
        likes_number = None
    return parse_facebook_likes_number(likes_number)
  ...
  def get_content(self, bs):
    ...
    try:
        ...
        movie['fb_like_num'] = self.get_facebook_likes(self.get_id_from_url(movie['movie_imdb_link']))
    except:
        movie['fb_like_num'] = None
    try:
    ...
    try:
        ...
        movie['prix'] = {"won": award_won, 'nominated': award_nominated}
    except Exception as e:
        print(e)
        movie['prix'] = None
    return movie